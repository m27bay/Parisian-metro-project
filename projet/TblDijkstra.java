...
public class TblDijkstra {
	...
	/**
	 * Constructeur d'objets de classe TblDijkstra,
	...
	public void calcul( int at, int to )
	{
		...
		int index_min;
		while( !finished() )
		{//tant que tous les indices ne sont pas traités
